...
import { useDeleteHome } from "hooks/home/useDeleteHome";
    ...
    <React.Fragment>
      ...
      >
        ...
        <DialogActions>
          ...
          {loading && <Loader />}
          <Button autoFocus sx={{}} variant="contained" onClick={DeleteHome}>
            {t("Agree")}
          </Button>
        </DialogActions>
      </Dialog>
