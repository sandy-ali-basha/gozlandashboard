...
const BlogView = () => {
  ...
  const columns = [
    {
      head: t("title"),
      value: data?.translations?.find((t) => t.locale === "en")?.title,
    },
    {
      head: t("title"),
    ...
    // {
    //   head: t("title"),
    //   value: data?.translations?.find((t) => t.locale === "kr")?.title,
    // },
  ];
  const texts = [
    {
      head: t("text"),
      value: data?.translations?.find((t) => t.locale === "en")?.text,
    },
    {
      head: t("text"),
    ...
    // {
    //   head: t("text"),
    //   value: data?.translations?.find((t) => t.locale === "kr")?.text,
    // },
  ];
